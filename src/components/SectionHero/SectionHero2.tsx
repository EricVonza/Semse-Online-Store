...
import imageRightPng from "images/a1mini-pc.png";
import imageRightPng2 from "images/a1-pc.png";
import imageRightPng3 from "images/x1-pc.png";
import imageRightPng4 from "images/p1s-pc.png";
      ...
      >
        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44">
          ...
          <div className="mt-10 lg:mt-0 lg:absolute right-0 bottom-0 top-0 w-full max-w-2xl xl:max-w-3xl 2xl:max-w-4xl">
            <img
              className="w-full h-2/3 object-contain object-right-bottom nc-SectionHero2Item__image"
              src={item.image}
              alt={item.heading}
            />
          </div>
