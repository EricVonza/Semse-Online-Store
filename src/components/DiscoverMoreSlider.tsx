...
import img1 from "images/collections/3d-printer-set.jpg";
import img3 from "images/collections/service-parts-pc.png";
import img2 from "images/collections/filament-pc.jpg";
...
export const CATS_DISCOVER: CardCategory3Props[] = [
  ...
  {
    name: "Filaments",
    desc: "Give the print <br /> a colour <br /> of choice",
    featuredImage: img2,
    color: "bg-red-50",
  },
  {
    name: "Accessories",
    desc: "We got you <br /> covered",
    featuredImage: img3,
    color: "bg-blue-50",
  },
  {
